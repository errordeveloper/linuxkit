...
- `envFromFile` specifies environment variables that need to be set based on content of files, e.g. for use when metadata needs to be used to set environment variables.
